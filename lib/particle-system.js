...
export class ParticleSystem {
    constructor(renderer, id = 'primary', particleSize = PARTICLE_SIZE) {
        this.id = id;
        this.renderer = renderer;
        this.particleSize = particleSize;
        this.gpuCompute = new GPUComputationRenderer(particleSize, particleSize, renderer);
        ...
        this.positionUniforms.speed = { value: 1.7 };
        this.positionUniforms.dieSpeed = { value: 0.01 };
        this.positionUniforms.radius = { value: 308.0 };
        this.positionUniforms.curlSize = { value: 0.1 };
        this.positionUniforms.attraction = { value: 2.9 };
        ...
        this.positionUniforms.wind = { value: new THREE.Vector3(0.9, 0.0, -1.0) };
        this.positionUniforms.bodyActivity = { value: 0.0 };
        this.positionUniforms.gridSpacing = { value: 1.3 };
        ...
        this.particleSort = new ParticleSort(renderer, particleSize);
        this.opacityPass = new OpacityPass(renderer, this.mesh.geometry, particleSize, this.pointSizeUniform);
    }
    ...
    _createParticleMesh() {
        ...
        this.pointSizeUniform = { value: 100.0 };
    ...
    dispose() {
        ...
        this.opacityPass.renderTarget.dispose();
        this.opacityPass.material.dispose();
    }
}
